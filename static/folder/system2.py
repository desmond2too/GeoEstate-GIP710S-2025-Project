...
def estimate_price(features):
    ...
    # Area multiplier (price per square meter) 
    ...
    bathroom_value = features['bathrooms'] * 40000
    ...
    if features.get('pool', False):
        feature_value += 120000    # Pools are premium features 
    ...
    if features.get('aircon', False):
        feature_value += 30000     # Air conditioning is a plus
